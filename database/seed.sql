-- Dummy Data for Railway Desktop Search Testing
...
('12951', 'Mumbai - New Delhi Rajdhani Express', 'Rajdhani', 2, 1),
...
-- 4. Train Schedules
-- We just insert start and end for simplicity now
INSERT INTO train_schedules (train_id, station_id, stop_sequence, arrival_time, departure_time, day_count) VALUES
(1, 2, 1, '17:00:00', '17:00:00', 1), -- Mumbai Central
(1, 1, 2, '08:32:00', '08:32:00', 2), -- New Delhi
(2, 5, 1, '06:00:00', '06:00:00', 1), -- Bengaluru
(2, 4, 2, '11:00:00', '11:00:00', 1); -- Chennai

-- 5. Train Instances (Specific Dates you can search)
-- I will add runs for 2026-04-01 to 2026-04-10
